...
## 3. Ao Ruan
##
## Run with micropython extension
## Boot the pico , let firmware be installed???
## Then right click on code and say run code on pico
##
##
## ----------------------------------------------------------------------------------------------
## Credits: Base Code from: https://github.com/en0b/rPi-Pico-micropython-Simple-SCD30/tree/master
## ----------------------------------------------------------------------------------------------
